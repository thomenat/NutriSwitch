...
const KITCHEN_UNITS: KitchenMapping = {
  ...
  "vegan-protein": [{ label: "tbsp", gramsPerUnit: 15, step: 0.5 }],
  ...
  "wholegrain-bread": [{ label: "slice", gramsPerUnit: 25, step: 1 }],
  "pita-bread": [{ label: "unit", gramsPerUnit: 65, step: 1 }],
  hummus: [{ label: "tbsp", gramsPerUnit: 10, step: 0.5 }],
  "brown-rice-dry": [{ label: "tbsp", gramsPerUnit: 20, step: 0.5 }],
  "quinoa-dry": [{ label: "tbsp", gramsPerUnit: 20, step: 0.5 }],
  "couscous-dry": [{ label: "tbsp", gramsPerUnit: 20, step: 0.5 }],
  "pasta-dry": [{ label: "tbsp", gramsPerUnit: 12, step: 0.5 }],
  "beans-cooked": [{ label: "ladle", gramsPerUnit: 100, step: 0.5 }],
  "lentils-cooked": [{ label: "ladle", gramsPerUnit: 100, step: 0.5 }],
  "chickpeas-cooked": [{ label: "serving spoon", gramsPerUnit: 60, step: 0.5 }],
  "soy-protein-dry": [{ label: "tbsp", gramsPerUnit: 15, step: 0.5 }],
  "whey-protein": [{ label: "scoop", gramsPerUnit: 30, step: 0.5 }],
  "red-berries": [{ label: "unit", gramsPerUnit: 12, step: 1 }],
  strawberries: [{ label: "unit", gramsPerUnit: 12, step: 1 }],
